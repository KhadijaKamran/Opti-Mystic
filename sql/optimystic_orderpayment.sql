...
CREATE TABLE `orderpayment` (
  ...
  PRIMARY KEY (`orderNo`),
  CONSTRAINT `fk_payOrd` FOREIGN KEY (`orderNo`) REFERENCES `productorders` (`orderNo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `orderpayment` VALUES (2,24750),(3,5000);
